...
- [Phase 4 Deep Assessment Implementation](patterns/phase4-assessment-implementation.md) — Deep Technical Assessment (Layer C): NanoGPT provider (instructor+openai), python-repomix packing, 8 dimension prompts, budget controller, heuristic fallback | Updated: 2026-04-23